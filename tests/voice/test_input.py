...
try:
    from pks.sdk.agents import UserError
    from pks.sdk.agents.voice import AudioInput, StreamedAudioInput
    from pks.sdk.agents.voice.input import DEFAULT_SAMPLE_RATE, _buffer_to_audio_file
except ImportError:
    pass
