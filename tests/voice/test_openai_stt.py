...
try:
    from pks.sdk.agents.voice import (
        OpenAISTTTranscriptionSession,
        StreamedAudioInput,
        STTModelSettings,
    )
    from pks.sdk.agents.voice.exceptions import STTWebsocketConnectionError
    from pks.sdk.agents.voice.models.openai_stt import EVENT_INACTIVITY_TIMEOUT
