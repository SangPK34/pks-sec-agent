...
from pks.repl.commands.load import LoadCommand
...
class TestLoadCommand:
    ...
    @patch("pks.repl.commands.load.console.input")
    @patch("pks.agents.get_agent_by_name")
    @patch("pks.sdk.agents.simple_agent_manager.AGENT_MANAGER")
    @patch("pks.sdk.agents.models.openai_chatcompletions.ACTIVE_MODEL_INSTANCES", {})
    @patch("pks.sdk.agents.models.openai_chatcompletions.PERSISTENT_MESSAGE_HISTORIES", {})
    @patch("pks.repl.commands.load.fast_load_messages")
    ...
    @patch("pks.repl.commands.load.get_all_agent_histories")
    ...
    @patch("pks.repl.commands.load.fast_load_messages")
    @patch("pks.repl.commands.load.get_agent_message_history")
    ...
    @patch("pks.agents.get_available_agents")
    @patch("pks.repl.commands.load.get_all_agent_histories")
    ...
    @patch("pks.sdk.agents.models.openai_chatcompletions.PERSISTENT_MESSAGE_HISTORIES", {})
    @patch("pks.agents.get_available_agents")
    @patch("pks.repl.commands.load.load_history_from_jsonl")
