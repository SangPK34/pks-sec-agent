"""Test custom prompts for parallel agents in PKS CLI."""

import pytest
from unittest.mock import MagicMock, patch
from pks.repl.commands.parallel import ParallelCommand, PARALLEL_CONFIGS, ParallelConfig
...
class TestParallelCustomPrompts:
    ...
    def test_prompt_subcommand_adds_prompt_to_config(self):
        ...
        # Add an agent first
        with patch("pks.repl.commands._parallel_monolith.console"):
        ...
        # Set a custom prompt
        with patch("pks.repl.commands._parallel_monolith.console") as mock_console:
    ...
    def test_custom_prompt_displayed_in_list(self):
        ...
        with patch("pks.repl.commands._parallel_monolith.Table") as mock_table:
            with patch("pks.repl.commands._parallel_monolith.console"):
