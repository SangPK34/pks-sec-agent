...
from pks.repl.commands.flush import FlushCommand
...
class TestFlushCommand:
    ...
    @patch("pks.sdk.agents.models.openai_chatcompletions.get_all_agent_histories")
    ...
    @patch("pks.repl.commands.flush.merge_flush_histories")
    @patch("pks.sdk.agents.models.openai_chatcompletions.get_agent_message_history")
    @patch("pks.sdk.agents.models.openai_chatcompletions.clear_agent_history")
    ...
    @patch("pks.sdk.agents.models.openai_chatcompletions.get_all_agent_histories")
    @patch("pks.sdk.agents.models.openai_chatcompletions.clear_all_histories")
...
class TestFlushCommandIntegration:
    ...
    @patch("pks.sdk.agents.models.openai_chatcompletions.get_agent_message_history")
    @patch("pks.sdk.agents.models.openai_chatcompletions.clear_agent_history")
    @patch("pks.sdk.agents.parallel_isolation.PARALLEL_ISOLATION")
    ...
    @patch("pks.sdk.agents.models.openai_chatcompletions.clear_agent_history")
    @patch("pks.sdk.agents.parallel_isolation.PARALLEL_ISOLATION")
    @patch("pks.repl.commands._parallel_monolith.PARALLEL_CONFIGS")
    @patch("pks.agents.get_available_agents")
    def test_handle_invalid_id(
        ...
        from pks.repl.commands.parallel import ParallelConfig
