...
from pks.repl.commands.parallel import ParallelCommand, ParallelConfig
import pks.repl.commands.parallel as parallel_module
...
class TestParallelCommand:
    ...
    @patch("pks.repl.commands._parallel_monolith.get_available_agents")
...
class TestParallelCommandIntegration:
    ...
    @patch("pks.repl.commands._parallel_monolith.get_available_agents")
    @patch("pks.repl.commands._parallel_monolith.get_all_agent_histories")
