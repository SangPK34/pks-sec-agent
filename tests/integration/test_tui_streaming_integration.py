#!/usr/bin/env python3
"""
Integration tests for PKS TUI streaming functionality.
...
from pks.sdk.agents.run import RunResult
from pks.sdk.agents.items import MessageOutputItem, ToolCallItem, ReasoningItem
from pks.agents import get_agent_by_name, get_all_agents
        ...
        async def stream_agent_response(context, agent_num):
            ...
            self.streaming_display.finish_streaming(stream_id, {
                "final_stats": {
                    ...
                    "context_usage_pct": 1.0 + agent_num,
                }
            })
