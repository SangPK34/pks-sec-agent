...
from pks.tui.display.streaming_display import StreamingDisplay
from pks.tui.display.tool_display import ToolDisplay
from pks.tui.display.agent_display import AgentDisplay
from pks.tui.display.manager import DisplayManager
from pks.tui.display.base import DisplayContext, OutputType
...
class TestStreamingBackwardCompatibility(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original_stream_env = os.environ.get("PKS_STREAM", "false")
        ...
        self.patcher = patch('pks.tui.core.terminal_console.get_terminal_output')
    ...
    def tearDown(self):
        """Clean up."""
        self.patcher.stop()
        os.environ["PKS_STREAM"] = self.original_stream_env
    ...
    def test_terminal_output_methods(self):
        ...
        with patch('pks.tui.core.terminal_console.get_terminal_output', return_value=terminal_with_write):
            self.agent_display.display(context, {
        ...
        with patch('pks.tui.core.terminal_console.get_terminal_output', return_value=terminal_with_print):
    ...
    def test_streaming_api_presence(self):
        ...
        with patch('pks.tui.core.terminal_console.get_terminal_output', return_value=basic_terminal):
