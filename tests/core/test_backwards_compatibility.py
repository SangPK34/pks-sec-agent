...
3. New format: session events + chat.completion with agent_name and timing

Old metadata fields are intentionally tolerated when loading historical logs.
"""
...
from pks.repl.session_resume import fast_load_messages, normalize_messages_for_agent
