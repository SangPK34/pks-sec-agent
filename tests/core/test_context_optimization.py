...
class TestModuleImport:
    ...
    def test_import_truncate_function(self):
        """The current per-result truncation function should remain importable."""
        from pks.sdk.agents._run_impl import truncate_output

        result = truncate_output("small", 1000)
        assert result == "small"

    def test_import_history_compaction_function(self):
        """The old-history compactor should remain importable."""
        from pks.sdk.agents.models.chatcompletions.auto_compactor import (
            _phase1_truncate_message_history,
        )

        assert _phase1_truncate_message_history([], keep_start=0) == (0, 0)

    def test_import_constants(self):
        """The old-history compaction limit should remain positive."""
        from pks.sdk.agents.models.chatcompletions.auto_compactor import (
