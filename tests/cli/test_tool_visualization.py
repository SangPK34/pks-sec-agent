...
Tests token display, panel creation, and streaming panels.
"""
...
class TestTokenInfoDisplay:
    ...
    def test_returns_none_for_empty_token_info(self):
        ...
        from pks.util import _create_token_info_display
...
class TestToolPanelContent:
    ...
    def test_creates_panel_with_basic_args(self):
        ...
        from pks.util import _create_tool_panel_content
...
class TestNormalizeTokenInfo:
    """Test normalize_token_info function."""
    ...
    def test_preserves_existing_values(self):
        ...
        enriched = normalize_token_info(token_info)
...
class TestTokenDisplay:
    ...
    def test_creates_display_with_basic_values(self):
        ...
        from pks.util import _create_token_display
...
class TestStreamingPanelGrouping:
    ...
    def test_grouped_streaming_tools_dict_exists(self):
        ...
        from pks.util import _GROUPED_STREAMING_TOOLS
    ...
    def test_live_streaming_panels_dict_exists(self):
        ...
        from pks.util import _LIVE_STREAMING_PANELS
        assert isinstance(_LIVE_STREAMING_PANELS, dict)


class TestModelTokenTracking:
    """Test model token tracking."""
...
class TestTimingInfo:
    ...
    def test_get_timing_info_returns_list(self):
        ...
        from pks.util import _get_timing_info
...
class TestFormatTime:
    ...
    def test_formats_seconds(self):
        ...
        from pks.util import format_time
...
class TestStreamingPanelFinalization:
    ...
    def test_single_tool_uses_single_panel_format(self):
        ...
        from pks.util import _GROUPED_STREAMING_TOOLS, _GROUPED_TOOLS_LOCK
...
class TestCtrlCInterruptHandling:
    ...
    def test_force_stop_all_panels_exists(self):
        ...
        from pks.util import _force_stop_all_panels
    ...
    def test_cleanup_handles_empty_panels(self):
        ...
        from pks.util import cleanup_all_streaming_resources, _LIVE_STREAMING_PANELS
    ...
    def test_signal_handler_function_exists(self):
        ...
        from pks.util import signal_handler
    ...
    def test_cleanup_clears_streaming_sessions(self):
        ...
        from pks.util import cleanup_all_streaming_resources, cli_print_tool_output
    ...
    def test_grouped_tools_lock_exists(self):
        ...
        from pks.util import _GROUPED_TOOLS_LOCK
        import threading
    ...
    def test_panel_update_lock_exists(self):
        ...
        from pks.util import _PANEL_UPDATE_LOCK
        import threading
...
def test_normal_repl_thinking_status_lifecycle(monkeypatch):
    import rich.status

    from pks.util.streaming import (
    ...
    monkeypatch.setattr("pks.repl.ui.compact_wiring.is_compact_enabled", lambda: False)
    monkeypatch.setattr("pks.util.wait_hints.wait_hints_enabled", lambda: True)

    context = create_claude_thinking_context("CTF agent", 1, "openai/CAI")
    status = context["status"]
    assert status is not None and status.started

    update_claude_thinking_content(context, "first line\nsecond line")
    assert "Thinking" in status.renderable.plain
    assert "2 lines" in status.renderable.plain

    finish_claude_thinking_display(context)
