...
class TestCLIStreaming(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        from pks.sdk.agents.models.openai_chatcompletions import PERSISTENT_MESSAGE_HISTORIES
    ...
    def add_to_test_message_history(self, msg):
        ...
        if not test_model:
            ...
            AGENT_MANAGER.set_active_agent(self._test_agent, test_agent_name)
    ...
    def test_streaming_mode_configuration(self):
        ...
        os.environ["PKS_STREAM"] = "false"
        assert os.environ["PKS_STREAM"] == "false"

        # Test streaming mode
        os.environ["PKS_STREAM"] = "true"
        assert os.environ["PKS_STREAM"] == "true"
