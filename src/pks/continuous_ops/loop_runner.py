...
def _ping_model(py: str) -> bool:
    ...
    code = (
        ...
        " if not key:\n"
        "  sys.exit(1)\n"
        " from pks.util.llm_api_base import resolve_llm_openai_compatible_base\n"
        " m=os.environ.get('PKS_MODEL','alias1')\n"
...
def main(run_dir: Path, *, entry_path: Path | None = None) -> int:
    ...
    os.environ["PKS_AGENT_ROUTE_MODE"] = "auto" if wt in ("selection_agent", "orchestration_agent") else "pinned"
