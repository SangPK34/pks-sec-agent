...
class MCPUtil:
    """Set of utilities for interop between MCP and PKS tools."""
    ...
    def _get_default_auth_token() -> str | None:
        ...
        - PKS_MCP_AUTH_TOKEN / PKS_MCP_TOKEN (raw token)
        - ALIAS_API_KEY / PKS_API_KEY (raw token; convenience fallback)
        """
        ...
        candidates = (
            ...
            os.getenv("MCP_TOKEN"),
            os.getenv("PKS_MCP_AUTH_TOKEN"),
            os.getenv("PKS_MCP_TOKEN"),
            os.getenv("ALIAS_API_KEY"),
            os.getenv("PKS_API_KEY"),
        )
    ...
    def to_function_tool(cls, tool: "MCPTool", server: "MCPServer") -> FunctionTool:
        """Convert an MCP tool to an PKS function tool."""
