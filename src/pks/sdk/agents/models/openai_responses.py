...
from pks.util.wait_hints import ModelStreamWaitHints, model_wait_hints
    ...
    async def get_response(
        ...
        try:
            ...
            if system_instructions:
                try:
                    from pks.sdk.agents.models.openai_chatcompletions import count_tokens_with_tiktoken as _ct
        ...
        with response_span(disabled=tracing.is_disabled()) as span_response:
            try:
                ...
                from pks.util import cli_print_agent_messages
