...
def get_model_max_tokens(model_name: str) -> int:
    ...
    Uses the same source as the pricing footer (:func:`pks.util.tokens.get_model_input_tokens`)
    so ``PKS_CONTEXT_USAGE``, auto-compact thresholds, and the sticky footer stay aligned.
...
async def _phase2_summarize(
    ...
    *,
    ...
    try:
        ...
        from pks.util.llm_api_base import resolve_llm_openai_compatible_api_key
