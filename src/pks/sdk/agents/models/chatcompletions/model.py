...
# ``from pks.sdk.agents.models.chatcompletions.model import X`` works
...
if os.getenv("PKS_MODEL") == "o3-mini" or os.getenv("PKS_MODEL") == "gemini-1.5-pro":
