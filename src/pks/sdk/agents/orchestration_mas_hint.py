...
next model step can fan out. Opt out with ``PKS_ORCHESTRATION_MAS_HINT=false``.
"""
...
def maybe_inject_orchestration_mas_hint_after_tools(
    *,
    ...
    if isinstance(md, dict) and md.get("_pks_mas_hint_injected"):
        return
    ...
    run_config.trace_metadata["_pks_mas_hint_injected"] = True
