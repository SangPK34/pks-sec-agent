    ...
    try:
        ...
        if _get_config().tui_enabled:
            try:
                ...
                with open(f"{_PKS_DEBUG_DIR}/cai_live_capture_debug.log", "a") as f:
                    import datetime
                ...
                import traceback
                with open(f"{_PKS_DEBUG_DIR}/cai_live_capture_error.log", "a") as f:
            ...
            try:
                ...
                try:
                    async def read_and_stream():
                        ...
                        if _get_config().tui_enabled:
                            with open(f"{_PKS_DEBUG_DIR}/cai_timeout_debug.log", "a") as f:
                                import datetime
