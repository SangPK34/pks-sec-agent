...
def create_cai_api_app(
    *,
    ...
    def _require_api_key(
        ...
        """
        # Prefer the client's ALIAS_API_KEY for authentication; fallback to PKS_API_KEY only if needed.
        root_key = os.getenv("ALIAS_API_KEY") or os.getenv("PKS_API_KEY")
    ...
    def list_models() -> ModelsResponse:
        ...
        from pks.util import get_pricings_dir
        import json as _json
        import os as _os
    ...
    def _run_litellm_title_summary(
        *,
        ...
        # Configure alias1 provider mapping (replicate PKS behavior)
        # Note: Using lower temperature (0.2) for focused/deterministic API responses
        # top_p uses default (1.0) from PKS_TOP_P env var
        kwargs = {
            "model": "alias1",
            ...
            "top_p": float(_os.getenv("PKS_TOP_P", "1.0")),  # Use env default
            "api_base": (_os.getenv("OPENAI_API_BASE") or _os.getenv("OPENAI_BASE_URL") or "http://localhost:20128/v1"),
