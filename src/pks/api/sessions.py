"""State management helpers for the PKS API backend."""
...
from pks.sdk.agents.items import ItemHelpers, TResponseInputItem
from pks.sdk.agents.result import RunResult
from pks.sdk.agents.run import DEFAULT_MAX_TURNS, Runner
...
"""Factory type used to construct PKS agents for sessions."""
...
class SessionManager:
    ...
    def __init__(self, agent_factory: AgentFactory | None = None) -> None:
        ...
        self._default_agent = os.getenv("PKS_AGENT_TYPE", DEFAULT_AGENT_TYPE)
        self._default_model = os.getenv("PKS_MODEL", "gpt-5.6-terra")
