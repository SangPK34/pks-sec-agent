...
environment using the `CTF` class from `pks.caibench.ctf`.
...
Usage:
    python3 src/pks/caibench/ctf_example.py <ctf_name>

Example:
    python3 src/pks/caibench/ctf_example.py picoctf_static_flag

"""
import sys
from pks.caibench.ctf import CTF
import json
import os
