"""
Attack Graph Construction Utilities - PKS-CTR Graph Processing Engine

This module provides comprehensive utilities for constructing, processing, and visualizing
attack graphs within the PKS-CTR integration. It handles the transformation of LLM-generated
...
def pks_set_default_weight(value):
    """
...
def connect_disconnected_starting_nodes(graph_structure, filtered_log, total_tokens, total_number_messages):
    """
