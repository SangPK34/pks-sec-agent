...
INTEGRATION POINTS:
==================
- PKS SDK: Agent framework, model abstraction, cost tracking
...
from pks.util import calculate_model_cost
...
model_name = os.getenv('PKS_MODEL', "alias1")
...
async def extract_attack_graph(input_log: Optional[str],
    ...
    Returns:
        tuple: (graph_structure, filtered_messages, inference_time_sec, inference_cost_usd, prompt_used)
            ...
            - inference_cost_usd: Dollar cost of LLM inference via PKS cost tracking
    ...
    Note:
        This function integrates with PKS's cost tracking system. CTR inference costs
