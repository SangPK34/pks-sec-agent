...
def _print_simple_tool_output(tool_name, args, output, execution_info=None, token_info=None):
    ...
    # PKS_DISPLAY_MAX_OUTPUT=true shows full output, false (default) truncates at 10000 chars
    show_full_output = os.getenv("PKS_DISPLAY_MAX_OUTPUT", "false").lower() in ("true", "1", "yes")
