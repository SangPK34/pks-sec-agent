"""
Interaction counter and limit enforcement for PKS sessions.
"""
...
from pks.util.timing import stop_active_timer, start_idle_timer
...
def check_interaction_limit(force_until_flag=False):
    import os
    limit_env = os.getenv("PKS_MAX_INTERACTIONS")
    try:
...
# at the next opportunity. Read/cleared by pks.util.user_prompts.
