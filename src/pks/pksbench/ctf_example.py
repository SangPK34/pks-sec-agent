...
environment using the `CTF` class from `pks.pksbench.ctf`.
...
Usage:
    python3 src/pks/pksbench/ctf_example.py <ctf_name>

Example:
    python3 src/pks/pksbench/ctf_example.py picoctf_static_flag

"""
import sys
from pks.pksbench.ctf import CTF
import json
import os
