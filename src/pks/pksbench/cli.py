...
# Example usage:
# 1. HackableII
# pks-bench start hackableII --ip-address 192.168.2.11
# pks-bench shell hackableII "ls"
# pks-bench stop hackableII

# 2. Bob
# pks-bench start bob --ip-address 192.168.2.10
# pks-bench stop bob

# 3. KiddoCTF
# pks-bench start kiddoctf --ip-address 192.168.2.12
# pks-bench stop kiddoctf