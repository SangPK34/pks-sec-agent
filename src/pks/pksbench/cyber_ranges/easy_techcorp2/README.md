...
- Caldera server installed at `~/Documents/pks_v0.4.0/pks/caldera-mitre`
- PKS agent environment activated
...
```bash
cd ~/Documents/pks_v0.4.0/pks/caldera-mitre
./START_CALDERA.sh
```
...
```bash
cd ~/Documents/pks_v0.4.0/pks/src/pks/pksbench/cyber_ranges/easy_techcorp2
docker-compose up -d
./setup-complete.sh
```
...
### Step 4: Launch PKS Caldera Agent

```bash
cd ~/Documents/pks_v0.4.0/pks
source pks_env/bin/activate
export PKS_AGENT_TYPE="caldera_agent"
pks
```
