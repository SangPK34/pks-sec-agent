...
- Shared CTR analysis triggered every PKS_GCTR_NITERATIONS combined tool uses
- CTR digest injected into both agents' system prompts using PKS_CTR_DIGEST_MODE
"""
