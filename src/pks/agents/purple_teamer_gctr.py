...
from pks.agents.gctr_mixin import SharedCTRHooks
from pks.sdk.agents import OpenAIChatCompletionsModel
...
def create_purple_team_agents(
    ...
    Args:
        n_interactions: Combined tool interactions before CTR triggers.
                       Defaults to PKS_GCTR_NITERATIONS env var (or 5).
    ...
    if use_base_agents:
        from pks.agents.red_teamer import redteam_agent as base_red
        from pks.agents.blue_teamer import blueteam_agent as base_blue
    else:
        from pks.agents.red_teamer_gctr import redteam_gctr_agent as base_red
        from pks.agents.blue_teamer_gctr import blueteam_gctr_agent as base_blue
