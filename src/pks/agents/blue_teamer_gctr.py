...
from pks.agents.gctr_mixin import make_gctr_agent
from pks.agents.blue_teamer import blueteam_agent as _base_agent
...
def create_blueteam_gctr_agent(n_interactions: Optional[int] = None):
    ...
    Args:
        n_interactions: CTR trigger threshold. If None, uses PKS_GCTR_NITERATIONS env.
    """
