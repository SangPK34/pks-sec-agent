...
from pks.tools.misc.reasoning import (  # pylint: disable=import-error # noqa: E501
    think,
    thought,
    write_key_findings,
    read_key_findings,
...
model_name = os.getenv("PKS_APT_AGENT_MODEL", _cfg.model)
...
if os.getenv("PKS_PLAN", "true").lower() == "true":
