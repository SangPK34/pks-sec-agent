...
from pks.tools.reconnaissance.shodan import shodan_search
from pks.tools.web.google_search import google_search
from pks.tools.misc.reasoning import think  # pylint: disable=import-error
from pks.tools.misc.blackboard_tools import note_finding, set_flag  # noqa: E501
...
# Define tool list based on available API keys (via PKSConfig) [S]
tools = [
    generic_linux_command,
    run_ssh_command_with_credentials,
    execute_code,
