...
from pks.repl.commands.parallel import PARALLEL_CONFIGS, ParallelConfig, PARALLEL_AGENT_INSTANCES
    ...
    async def _execute_agent_instance(
        ...
        try:
            ...
            if not instance_agent:
                ...
                # Determine model
                model_to_use = config.model or os.getenv("PKS_MODEL", "gpt-5.6-terra")
