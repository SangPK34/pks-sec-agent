...
class ActualActionBar(VerticalScroll):
    ...
    def __init__(self, terminal_number: int = 1, **kwargs):
        ...
        self._current_prompt = f"pks@terminal-{terminal_number}"
        ...
        # Allow tuning via env var (e.g., PKS_TUI_MAX_RERENDERS_PER_SEC=8)
        try:
            fps = float(os.getenv("PKS_TUI_MAX_RERENDERS_PER_SEC", "10"))
    ...
    def on_mount(self) -> None:
        ...
        if self._action_log:
            ...
            line.append("PKS> ", style="bold green")
    ...
    def start_streaming(self, agent_name: str = "agent", is_tool: bool = False) -> None:
        ...
        self._current_text = ""
        self._current_prompt = f"pks@{agent_name.lower()}"
    ...
    def update_streaming_text(self, text: str) -> None:
        ...
        if self._is_streaming and self._action_log and hasattr(self, '_log_history'):
            ...
            try:
                ...
                # Log any error
                try:
                    with open(f"{_PKS_DEBUG_DIR}/pks_rich_write_error.log", "a") as f:
                        import traceback
    ...
    def show_command(self, command: str) -> None:
        ...
        self._add_log_entry("PKS> ", f"$ {command}", "bold yellow")
            ...
            try:
                ...
                if hasattr(self, '_current_text') and hasattr(self, '_log_history'):
                    ...
                    if not getattr(self, '_is_tool_stream', False):
                        err_line.append("PKS> ", style="bold green")
    ...
    def add_tool_exec_indicator_bottom(self, tool_name: str, args: dict | str | None = None) -> None:
        ...
        try:
            ...
            try:
                from pks.repl.commands.mcp import get_mcp_server_for_tool
