...
from pks.tui.components.universal_terminal import TerminalRole, UniversalTerminal
...
class StableTerminalGrid(ScrollableContainer):
    ...
    def setup_parallel_agents(self, agent_configs: list[any]) -> None:
        ...
        # This method is now handled directly in pks_terminal.py
    ...
    # Compatibility methods for pks_terminal.py
    ...
    def focus_terminal(self, terminal_id: str) -> None:
        ...
        if hasattr(self, 'app') and self.app:
            ...
            if main_terminal and os.getenv("PKS_DEBUG") == "2":
