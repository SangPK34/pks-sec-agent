"""Command handler component for PKS TUI"""
...
from pks.repl.commands import get_command, handle_command as commands_handle_command
...
class CommandHandler:
    ...
    def handle_command(self, command: str) -> None:
        ...
        had_active_terminal = "PKS_ACTIVE_COMMAND_TERMINAL" in os.environ
        previous_active_terminal = os.environ.get("PKS_ACTIVE_COMMAND_TERMINAL")
        had_active_terminal_id = "PKS_ACTIVE_COMMAND_TERMINAL_ID" in os.environ
        previous_active_terminal_id = os.environ.get("PKS_ACTIVE_COMMAND_TERMINAL_ID")
        ...
        try:
            ...
            from pks.repl.commands import base
            ...
            for name in list(sys.modules.keys()):
                if name.startswith("pks.repl.commands.") and name != "pks.repl.commands":
            ...
            os.environ["PKS_ACTIVE_COMMAND_TERMINAL"] = str(self.terminal_number)
            if terminal_id:
                os.environ["PKS_ACTIVE_COMMAND_TERMINAL_ID"] = str(terminal_id)
            else:
                os.environ.pop("PKS_ACTIVE_COMMAND_TERMINAL_ID", None)
            ...
            is_broadcast_mode = os.getenv("PKS_BROADCAST_MODE") == "true"
            if (
            ...
            if had_active_terminal:
                os.environ["PKS_ACTIVE_COMMAND_TERMINAL"] = previous_active_terminal or ""
            else:
                os.environ.pop("PKS_ACTIVE_COMMAND_TERMINAL", None)

            if had_active_terminal_id:
                if previous_active_terminal_id is not None:
                    os.environ["PKS_ACTIVE_COMMAND_TERMINAL_ID"] = previous_active_terminal_id
                else:
                    os.environ.pop("PKS_ACTIVE_COMMAND_TERMINAL_ID", None)
            else:
                os.environ.pop("PKS_ACTIVE_COMMAND_TERMINAL_ID", None)
