...
class UniversalTerminal(Container):
    ...
    def on_mount(self) -> None:
        ...
        try:
            ...
            try:
                ...
                current_model = self.state.model_name or os.getenv("PKS_MODEL", "alias1")
                if current_model:
    ...
    async def _configure_as_agent(self, agent_name: str) -> None:
        ...
        try:
            ...
            self.agent = get_agent_by_name(
                agent_name,
                agent_id=agent_id,
                model_override=os.getenv("PKS_MODEL", "alias1")
            )
    ...
    def _log_streaming_error(self, line_id: str, error: Exception):
        ...
        try:
            import traceback
            with open(f"{_PKS_DEBUG_DIR}/cai_streaming_errors.log", "a") as f:
