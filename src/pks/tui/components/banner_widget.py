"""
Banner widget for PKS TUI - displays the PKS logo instantly with modern styling
"""
...
class BannerWidget(Container):
    """Widget that displays the PKS banner instantly with modern effects"""
    ...
    async def show_banner(self, output: RichLog = None) -> None:
        ...
        # Modern PKS banner with gradient effect
        banner_lines = [
            ...
            "[bold #03fcb1]                CCCCCCCCCCCCC               ++              IIIIIIIIII[/bold #03fcb1]",
            "",
            f"[bold #03fcb1 on #111111]  ◆ Cybersecurity AI (PKS), v{version} ◆  [/bold #03fcb1 on #111111]",
