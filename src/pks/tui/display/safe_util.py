...
def _call_safe_function(func_name: str, *args, **kwargs) -> Any:
    ...
    try:
        ...
        from pks.tui.display.original_functions import get_original_function
        ...
        util_module = sys.modules.get('pks.util')
        if util_module and hasattr(util_module, func_name):
            ...
            print(f"[WARNING] Could not find {func_name} in pks.util", file=sys.stderr)
            return None
    finally:
