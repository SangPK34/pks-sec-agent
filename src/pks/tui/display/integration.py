"""
Integration layer between PKS core and TUI display system
"""
...
def display_tool_output(
    ...
    if display_manager.get_mode() == DisplayMode.TUI:
        ...
        if not terminal_id:
            from pks.tui.display.handoff_context import get_display_context
...
def start_tool_streaming(
    ...
    if display_manager.get_mode() == DisplayMode.TUI:
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import start_tool_streaming
...
def update_tool_streaming(
    ...
    if display_manager.get_mode() == DisplayMode.TUI:
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import update_tool_streaming
...
def finish_tool_streaming(
    ...
    if display_manager.get_mode() == DisplayMode.TUI:
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import finish_tool_streaming
...
def update_agent_streaming_content(
    ...
    if display_manager.get_mode() == DisplayMode.TUI or context.get("is_tui"):
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import update_agent_streaming_content
...
def finish_agent_streaming(context: Dict[str, Any], final_stats: Optional[Dict] = None) -> bool:
    ...
    if display_manager.get_mode() == DisplayMode.TUI or context.get("is_tui"):
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import finish_agent_streaming
...
def start_thinking_display_if_applicable(
    ...
    if display_manager.get_mode() == DisplayMode.TUI:
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import start_claude_thinking_if_applicable
...
def update_thinking_content(context: Dict[str, Any], thinking_delta: str) -> bool:
    ...
    if display_manager.get_mode() == DisplayMode.TUI or context.get("is_tui"):
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import update_claude_thinking_content
...
def finish_thinking_display(context: Dict[str, Any]) -> bool:
    ...
    if display_manager.get_mode() == DisplayMode.TUI or context.get("is_tui"):
        ...
        # Fall back to CLI display
        from pks.tui.display.safe_util import finish_claude_thinking_display
