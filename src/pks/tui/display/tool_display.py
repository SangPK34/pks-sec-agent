...
class ToolDisplay(BaseDisplay):
    ...
    def display(self, context: DisplayContext, data: dict[str, Any]) -> None:
        ...
        try:
            ...
            from pks.tui.core.terminal_widget_registry import get_terminal_widget, get_terminal_widget_by_agent_id
            
            # Debug logging for terminal routing
            try:
                with open(f"{_PKS_DEBUG_DIR}/cai_action_bar_routing.log", "a") as f:
                    import datetime
    ...
    def update_streaming(self, stream_id: str, data: dict[str, Any]) -> None:
        ...
        # Debug log
        with open(f"{_PKS_DEBUG_DIR}/cai_tool_streaming_debug.log", "a") as f:
