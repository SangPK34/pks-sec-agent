...
class DisplayWrapper:
    ...
    def __init__(self):
        ...
        self._is_tui = os.getenv("PKS_TUI_MODE") == "true"
    ...
    def print_tool_output(
        ...
        if os.getenv("PKS_DEBUG_DISPLAY"):
        ...
        try:
            ...
            if self._is_tui:
                from pks.tui.display.integration import display_tool_output
                ...
                from pks.tui.display import safe_util
    ...
    def start_tool_streaming(
        ...
        if self._is_tui:
            from pks.tui.display.integration import start_tool_streaming
    ...
    def update_tool_streaming(
        ...
        if self._is_tui:
            from pks.tui.display.integration import update_tool_streaming
    ...
    def finish_tool_streaming(
        ...
        if self._is_tui:
            from pks.tui.display.integration import finish_tool_streaming
    ...
    def create_agent_streaming_context(
        ...
        if self._is_tui:
            from pks.tui.display.integration import create_agent_streaming_context
    ...
    def update_agent_streaming_content(
        ...
        if self._is_tui:
            from pks.tui.display.integration import update_agent_streaming_content
    ...
    def finish_agent_streaming(
        ...
        if self._is_tui:
            from pks.tui.display.integration import finish_agent_streaming
    ...
    def start_thinking_if_applicable(
        ...
        if self._is_tui:
            from pks.tui.display.integration import start_thinking_display_if_applicable
    ...
    def update_thinking_content(self, context: dict[str, Any], thinking_delta: str) -> bool:
        ...
        if self._is_tui:
            from pks.tui.display.integration import update_thinking_content
    ...
    def finish_thinking_display(self, context: dict[str, Any]) -> bool:
        ...
        if self._is_tui:
            from pks.tui.display.integration import finish_thinking_display
