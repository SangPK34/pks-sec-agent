...
class DisplayManager:
    ...
    def display_agent_messages(
        ...
        if self._mode != DisplayMode.TUI:
            from pks.tui.display.safe_util import cli_print_agent_messages
    ...
    def start_thinking_display(
        ...
        if self._mode != DisplayMode.TUI:
            from pks.tui.display.safe_util import create_claude_thinking_context
    ...
    def is_thinking_supported(self, model_name: str) -> bool:
        ...
        from pks.tui.display.safe_util import detect_claude_thinking_in_stream
