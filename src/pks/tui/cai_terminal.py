...
from pks.config import get_config as _get_cai_config
...
class PKSTerminal(App):
    ...
    def on_mount(self) -> None:
        ...
        from pks.sdk.agents.models.openai_chatcompletions_info_bar_integration import (
...
def run_cai_tui():
    ...
    try:
        ...
        cost_line.append(f"${cost:.6f}", style=f"bold {PKS_GREEN}")
