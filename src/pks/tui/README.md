# PKS Terminal User Interface

Clean architecture implementation of the PKS Terminal User Interface using Textual.

## Overview

The PKS TUI provides a modern terminal interface for interacting with PKS agents. It features:
...
- **Banner Animation**: PKS banner appears with cascade effect in all terminals
...
### Core Components (`src/pks/tui/core/`)
...
#### 4. **BannerWidget**
- Displays the PKS ASCII art logo
...
- Handles /commands
- Integrates with PKS REPL commands
...
3. PKS banner appears in all terminals with cascade effect
...
src/pks/tui/
├── README.md                  # This file
├── pks_terminal.py           # Main application
...
└── components/              # UI components
    ...
    ├── banner_widget.py      # PKS banner display
...
2. Import and compose in `pks_terminal.py`
