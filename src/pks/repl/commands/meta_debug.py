...
class MetaDebugCommand(Command):
    ...
    def handle(self, args: Optional[List[str]] = None) -> bool:
        ...
        if os.getenv("PKS_META_AGENT", "false").lower() != "true":
            console.print("[yellow]Meta Agent is not enabled. Set PKS_META_AGENT=True to enable.[/yellow]")
            return True
        ...
        env_vars = ["PKS_META_AGENT", "PKS_META_MODEL", "PKS_MODEL", "OPENAI_API_KEY", "ANTHROPIC_API_KEY"]
        for var in env_vars:
            value = os.getenv(var)
