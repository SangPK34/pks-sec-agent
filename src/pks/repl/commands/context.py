"""
Context usage command for PKS REPL (CLI).
...
from pks.sdk.agents.models.chatcompletions.token_counter import count_tokens_with_tiktoken
    ...
    def handle_trim(self, args: Optional[List[str]] = None) -> bool:
        ...
        try:
            ...
            if max_tokens > 0:
                ...
                os.environ["PKS_CONTEXT_USAGE"] = str(min(1.0, max(0.0, after / max_tokens)))
        except Exception:
            pass
