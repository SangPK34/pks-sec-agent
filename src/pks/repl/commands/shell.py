...
from pks.tools.common import _get_workspace_dir, _get_container_workspace_path
from pks.util.cli_palette import PKS_GREEN, GREY_TEXT, ORANGE_WARN, YELLOW_WARN
...
class ShellCommand(Command):
    ...
    def handle_shell_command(self, command_args: List[str]) -> bool:
        ...
        def run_command(command, cwd=None):
            ...
            try:
                ...
                if is_async:
                    ...
                    os.system(command)
                    console.print(
                        f"[bold {PKS_GREEN}]Async command completed or detached[/bold {PKS_GREEN}]"
                    )
                    return True
                ...
                if process.returncode == 0:
                    console.print(
                        f"[bold {PKS_GREEN}]Command completed successfully[/bold {PKS_GREEN}]"
                    )
                else:
                    console.print(
        ...
        if active_container:
            ...
            console.print(
                f"[bold {PKS_GREEN}]Container workspace[/bold {PKS_GREEN}] "
