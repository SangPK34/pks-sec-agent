"""
Memory command for PKS REPL.
Manages memory storage in .pks/memory for persistent context.
"""
...
from pks.repl.commands.parallel import PARALLEL_CONFIGS
from pks.sdk.agents.simple_agent_manager import AGENT_MANAGER, DEFAULT_SESSION_AGENT_ID
...
def _async_openai_client_for_memory_summary(model_name: str) -> AsyncOpenAI:
    ...
    from pks.sdk.agents.models import _openai_shared
    from pks.sdk.agents.models.openai_provider import OpenAIProvider
    from pks.util.llm_api_base import model_qualifies_for_alias_api_url
...
def get_compact_model():
    try:
        from pks.repl.commands.compact import get_compact_model as _get_compact_model
...
MEMORY_DIR = Path.home() / ".pks" / "memory"
...
class MemoryCommand(Command):
    ...
    def handle(self, args: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory list[/bold #ff3355]"
            "[#9aa0a6]                - List all stored memories[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory save[/bold #ff3355]"
            "[#9aa0a6]                - Save current agent history as memory[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory apply[/bold #ff3355]"
            "[#9aa0a6]               - Apply a memory to an agent[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory show[/bold #ff3355]"
            "[#9aa0a6]                - Show memory content[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory delete[/bold #ff3355]"
            "[#9aa0a6]              - Delete a stored memory[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory merge[/bold #ff3355]"
            "[#9aa0a6]               - Merge multiple memories into one[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory status[/bold #ff3355]"
            "[#9aa0a6]              - Show memory status[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory compact[/bold #ff3355]"
            "[#9aa0a6]             - Compact and save agent history[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory remove[/bold #ff3355]"
            "[#9aa0a6]              - Remove a specific memory from an agent[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory clear[/bold #ff3355]"
            "[#9aa0a6]               - Clear all memories from an agent[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory list-applied[/bold #ff3355]"
    ...
    def handle_control_panel(self) -> bool:
        ...
        if memories:
            ...
            table = Table(
                title="[bold #ff3355]Stored memories[/bold #ff3355]",
                show_header=True,
        ...
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory save <name>[/bold #ff3355]"
            "[#9aa0a6]         - Save current agent as memory[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory apply <ID/name>[/bold #ff3355]"
            "[#9aa0a6]     - Apply memory to P0 session agent (default)[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory apply <ID> all[/bold #ff3355]"
            "[#9aa0a6]      - Apply to all active agents[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory show <ID/name>[/bold #ff3355]"
            "[#9aa0a6]      - View memory content[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory delete <ID/name>[/bold #ff3355]"
            "[#9aa0a6]    - Delete a memory[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory merge <ID1> <ID2>[/bold #ff3355]"
            "[#9aa0a6]   - Merge multiple memories[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory compact <agent>[/bold #ff3355]"
            "[#9aa0a6]     - Compact agent history to memory[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory remove <ID> <agent>[/bold #ff3355]"
            "[#9aa0a6] - Remove a specific memory from agent[/]"
        )
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory clear <agent>[/bold #ff3355]"
    ...
    def handle_list(self, args: Optional[List[str]] = None) -> bool:
        ...
        console.print(table)
        console.print("\n[#9aa0a6][PKS] Commands:[/]")
        console.print("[#9aa0a6]  • [/][bold #ff3355]/memory show <ID/name>[/bold #ff3355][#9aa0a6] - View memory content[/]")
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/memory apply <ID/name>[/bold #ff3355]"
            "[#9aa0a6] - Apply memory to P0 session agent (default)[/]"
        )
        console.print("[#9aa0a6]  • [/][bold #ff3355]/memory apply <ID/name> all[/bold #ff3355][#9aa0a6] - Apply to all active agents[/]")
        console.print("[#9aa0a6]  • [/][bold #ff3355]/memory delete <ID/name>[/bold #ff3355][#9aa0a6] - Delete a memory[/]")
        console.print("[#9aa0a6]  • [/][bold #ff3355]/memory merge <ID1> <ID2>[/bold #ff3355][#9aa0a6] - Merge multiple memories[/]")
        console.print(
            "[#9aa0a6]\n[PKS] Note: You can use either the memory ID (e.g., M001) or the full name.[/]"
        )
    ...
    def handle_save(self, args: Optional[List[str]] = None, preserve_history: bool = True) -> bool:
        ...
        history = []
        if os.getenv("PKS_TUI_MODE") == "true" and "(" in agent_name and ")" in agent_name:
            ...
            if terminal_num and terminal_num.isdigit():
                ...
                if p_id in AGENT_MANAGER._message_history:
                    ...
                    try:
                        from pks.tui.core.session_manager import SessionManager
        ...
        console.print(
            f"\n[#9aa0a6][PKS] Saving memory for [/][bold #ff3355]{agent_name}[/bold #ff3355][#9aa0a6]...[/]"
        )
        ...
        if summary:
            ...
            if os.getenv("PKS_TUI_MODE") == "true" and " (T" in agent_name:
...
Model: {get_compact_model() or os.environ.get("PKS_MODEL", "gpt-4")}
...
"""
            ...
            os.environ["PKS_COMPACTED_MEMORY"] = "true"
...
"""
    ...
    async def _ai_summarize_history(self, agent_name: Optional[str] = None) -> Optional[str]:
        ...
        from pks.repl.commands.compact import get_compact_model, get_custom_prompt

        # Create summary agent
        model_name = get_compact_model() or os.environ.get("PKS_MODEL", "alias1")
...
The goal: the next agent reads this summary and IMMEDIATELY executes the next command without preamble, questions, or reconnaissance."""
        ...
        # Generate summary
        console.print(
            f"[#9aa0a6][PKS] Generating summary for [/][bold #ff3355]{target}[/bold #ff3355]"
            f"[#9aa0a6] using [/][bold white]{model_name}[/bold white][#9aa0a6]...[/]"
        )
        console.print(
            f"[#9aa0a6][PKS] Processing [/][bold white]{len(history)}[/bold white]"
            f"[#9aa0a6] messages... this may take a moment.[/]"
        )

        try:
            # In TUI mode, use streaming to show progress
            if os.getenv("PKS_TUI_MODE") == "true" and os.getenv("PKS_STREAM", "false").lower() == "true":
...
{conversation_text}"""
        ...
        try:
            ...
            if agent_id in (DEFAULT_SESSION_AGENT_ID, "P1") and not AGENT_MANAGER._parallel_agents:
                ...
                try:
                    ...
                    if hasattr(pks.cli, "agent"):
                        pks.cli.agent = new_agent
                except:
                    pass
    ...
    def handle_list_applied(self, args: Optional[List[str]] = None) -> bool:
        ...
        if not args:
            ...
            for agent_name, memory_ids in APPLIED_MEMORY_IDS.items():
                console.print(f"[bold #ff3355]{agent_name}:[/bold #ff3355]")
            ...
            if isinstance(memory_ids, list):
                for i, memory_id in enumerate(memory_ids):
                    ...
                    console.print(
                        f"[bold #ff3355]{i+1}. {memory_id}[/bold #ff3355] - {memory_file}"
                    )
                    if summary_preview:
                ...
                memory_file = index.get("mappings", {}).get(memory_ids, "Unknown")
                console.print(
                    f"[bold #ff3355]1. {memory_ids}[/bold #ff3355] - {memory_file}"
                )
...
def get_compacted_summary(agent_name: Optional[str] = None) -> Optional[str]:
    ...
    agent sees the same context via ``PKS_SESSION_COMPACT_SUMMARY``.
    ...
    parts: List[str] = []
    try:
        from pks.util.session_compact import get_session_compact_summary
