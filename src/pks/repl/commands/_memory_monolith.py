...
def _async_openai_client_for_memory_summary(model_name: str) -> AsyncOpenAI:
    """Build the same OpenAI-compatible client used by interactive agents."""
    del model_name
        ...
        if agent_identifier.upper() in (DEFAULT_SESSION_AGENT_ID.upper(), "P1"):
            ...
            if current_agent:
                ...
                if not agent_name:
                    ...
                    agent_type = os.getenv("PKS_AGENT_TYPE", "root_agent")
                    from pks.agents import get_available_agents
...
"""
    ...
    async def _ai_summarize_history(self, agent_name: Optional[str] = None) -> Optional[str]:
        ...
        model_name = get_compact_model() or os.environ.get("PKS_MODEL", "gpt-5.6-terra")
