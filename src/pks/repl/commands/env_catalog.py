...
ENV_VARS: Dict[int, Dict[str, object]] = {
    ...
    9: {"name": "PKS_MODEL", "description": "Model to use for agents", "default": "alias1"},
    10: {
        "name": "PKS_AGENT_TYPE",
    ...
    30: {"name": "PKS_PRICE_LIMIT", "description": "Price limit in dollars", "default": "1"},
    ...
    36: {"name": "PKS_CTX_TRUNC", "description": "Enable context truncation", "default": "false"},
    37: {"name": "PKS_DISPLAY_MAX_OUTPUT", "description": "Show full output (no truncation)", "default": "false"},
    ...
    48: {"name": "PKS_CTR_DIGEST_MODEL", "description": "Model for LLM-based CTR", "default": "alias1"},
    ...
    58: {"name": "PKS_DISABLE_USAGE_TRACKING", "description": "Disable usage tracking", "default": "false"},
    ...
    61: {"name": "PKS_COST_DISPLAYED", "description": "Show cost display", "default": "false"},
    62: {"name": "PKS_ENABLE_PRICING_FETCH", "description": "Enable async pricing fetch", "default": "false"},
    63: {"name": "PKS_DEBUG_PRICING", "description": "Debug pricing calculations", "default": "false"},
    64: {"name": "PKS_PRICING_FILE", "description": "Custom pricing data file", "default": None},
    65: {"name": "PKS_PRICINGS_DIR", "description": "Pricing data directory", "default": None},
    ...
    97: {"name": "PKS_UNATTRIBUTED_LOG", "description": "Unattributed content log", "default": "~/.cai_unattributed.log"},
...
def handle_env_catalog_set(args: Optional[List[str]] = None) -> bool:
    ...
    if var_name == "PKS_ALIAS_RATE_TIER" and value != old_value:
        try:
            from pks.util.gateway_rate_limiter import reset_gateway_rate_limiter
