...
class ApiCommand(Command):
    def __init__(self):
        super().__init__(
            name="/api",
            description="Show or set ALIAS_API_KEY in .env (Alias / PKS PRO)",
            aliases=["/apikey"],
        )
    ...
    def handle_show(self, args: Optional[List[str]] = None) -> bool:
        try:
            ...
            if current_key:
                ...
                console.print(
                    Panel(
                        f"ALIAS_API_KEY (masked): [bold {_PKS_GREEN}]{masked_key}[/bold {_PKS_GREEN}]{source_note}",
    ...
    def handle_set(self, args: Optional[List[str]] = None) -> bool:
        ...
        try:
            ...
            if success:
                ...
                console.print(
                    Panel(
                        f"ALIAS_API_KEY updated (masked): [bold {_PKS_GREEN}]{masked_key}[/bold {_PKS_GREEN}]\n"
