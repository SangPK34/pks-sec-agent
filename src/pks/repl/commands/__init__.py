...
def _ensure_command_loaded(module_name: str):
    ...
    if module_name not in _loaded_modules:
        try:
            importlib.import_module(f'pks.repl.commands.{module_name}')
...
def get_fuzzy_completer():
    ...
    if FuzzyCommandCompleter is None:
        from pks.repl.commands.completer import FuzzyCommandCompleter as _FuzzyCompleter
