...
``from pks.repl.commands.parallel import PARALLEL_CONFIGS`` continue to work.
"""

from pks.repl.commands._parallel_monolith import *  # noqa: F401,F403

# Explicit re-exports for static analysis and external consumers
from pks.repl.commands._parallel_monolith import (  # noqa: F811
    PARALLEL_CONFIGS,
