...
from pks.util.hint_renderables import build_cai_markup_line
...
def _resolve_alias_model_name(model_name: str | None) -> str:
    """Return alias-family model, falling back to PKS_MODEL then alias1."""
...
class ParallelCommand(Command):
    ...
    def _handle_no_args_tui(self) -> bool:
        ...
        try:
            from pks.tui.cai_terminal import PKSTerminal
    ...
    def handle_override_models(self, args: Optional[list[str]] = None) -> bool:
        ...
        global_model = os.getenv("PKS_MODEL", "alias1")
        count = 0
    ...
    async def _summarize_one_worker_history_async(
        ...
        try:
            model_name = get_compact_model() or os.getenv("PKS_MODEL", "alias1")
