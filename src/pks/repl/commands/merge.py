"""
Merge command for PKS CLI - alias for /parallel merge.
...
from pks.repl.commands.parallel import ParallelCommand
...
class MergeCommand(Command):
    ...
    def handle_no_args(self) -> bool:
        ...
        console.print(build_pks_markup_line("[#9aa0a6]Merging all agents by default...[/]"))
        console.print()
