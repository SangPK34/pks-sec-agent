...
class HistoryCommand(Command):
    ...
    def handle_control_panel(self) -> bool:
        ...
        current_agent_type = os.getenv("PKS_AGENT_TYPE", "one_tool_agent")
        ...
        tree = Tree("[bold #ff3355]Agent History Control Panel[/bold #ff3355]")
        ...
        for display_name, agent_info in sorted(
            ...
            memory_indicator = ""
            try:
                from pks.repl.commands.memory import COMPACTED_SUMMARIES, APPLIED_MEMORY_IDS
                ...
                if base_agent_name in COMPACTED_SUMMARIES:
                    ...
                    if base_agent_name in APPLIED_MEMORY_IDS:
                        ...
                        memory_indicator = (
                            f" [#9aa0a6](Memory: [/][bold #ff3355]{memory_id}[/bold #ff3355][#9aa0a6])[/]"
                        )
                    else:
            ...
            if is_current:
                branch_text = (
                    f"[bold #ff3355]{display_name}[/bold #ff3355] "
        ...
        console.print(tree)
        console.print(
            f"\n[#9aa0a6][PKS] Total messages across all agents:[/] [bold #ff3355]{total_messages}[/bold #ff3355]"
        )

        # Show usage hints
        console.print("\n[#9aa0a6][PKS] Commands:[/]")
        console.print(
            "[#9aa0a6]  • [/][bold #ff3355]/history <ID>[/bold #ff3355][#9aa0a6] - View specific agent by ID (e.g., P1)[/]"
        )
        console.print("[#9aa0a6]  • [/][bold #ff3355]/history agent <name>[/bold #ff3355][#9aa0a6] - View by agent name[/]")
        console.print("[#9aa0a6]  • [/][bold #ff3355]/history search <term>[/bold #ff3355][#9aa0a6] - Search across all agents[/]")
        console.print("[#9aa0a6]  • [/][bold #ff3355]/history index <ID> <num>[/bold #ff3355][#9aa0a6] - View specific message by index[/]")
