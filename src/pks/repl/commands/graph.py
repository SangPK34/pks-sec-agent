...
class GraphCommand(Command):
            ...
            try:
                ...
                if not app:
                    try:
                        ...
                        app = App.get_running()
                        if app and not isinstance(app, PKSTerminal):
                            app = None
                    except:
                        pass
        ...
        try:
            ...
            def render_graph(G):
                ...
                for i, (idx, data) in enumerate(node_list):
                    ...
                    # Color based on role type (PKS REPL palette)
                    if "Tool:" in role:
            ...
            try:
                ...
                if app and hasattr(app, 'session_manager') and app.session_manager.terminal_runners:
                    ...
                    if all_histories:
                        ...
                        console.print(Rule(style=_PKS_GREEN))
    ...
    def handle_export(self, args: Optional[List[str]] = None) -> bool:
        ...
        if not filename:
            ...
            filename = f"pks_graph_{timestamp}.{format_type}"
        ...
        try:
            if format_type == "json":
                ...
                dot_content = ["digraph PKS_Conversations {"]
                ...
                mermaid_content.extend(
                    [
                        ...
                        f"classDef assistant fill:{_PKS_GREEN},stroke:#0d3320,color:#000",
