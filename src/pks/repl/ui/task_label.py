...
live row (and stored in :class:`pks.output.TaskRecord`). Today it is inferred
...
Reuses :func:`pks.util.terminal._tool_command_line_display` and
:func:`pks.util.terminal._format_tool_args` to keep a single source of truth.
"""
...
from pks.util.terminal import _format_tool_args, _tool_command_line_display
