"""
Module for PKS REPL key bindings.
"""
...
def create_key_bindings(current_text):
    ...
    def _repl_input_shortcuts_on_question(event):
        ...
        def _show() -> None:
            try:
                ...
                from pks.repl.ui.repl_input_shortcuts import print_repl_input_shortcuts
                from pks.repl.ui.prompt import _print_separator
    ...
    def _expand_task(event):
        ...
        def _show() -> None:
            try:
                from pks.repl.ui.expand_popup import open_expand_popup
    ...
    def _handle_ctrl_z(event):
        """Intercept Ctrl+Z to prevent suspension and treat it like EOF/Interrupt."""
