...
from pks.config import ORCHESTRATION_AGENT_TYPE
...
def orchestration_beta_text() -> Text:
    ...
    return Text.from_markup(
        ...
        "Prefer root_agent for direct utility work and stable specialist routing.[/dim]"
    )
...
def orchestration_beta_panel_line() -> str:
    ...
    return (
        ...
        "(run_specialist, contest, parallel scouts). "
        "Prefer root_agent for direct utility work and stable specialist routing."
    )
