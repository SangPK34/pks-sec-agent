...
<head>
  ...
  <title>Case Study - PKS-powered API vulnerability discovery at Mercado Libre</title>
  <link rel="stylesheet" href="css/use-case.css">
  <link rel="stylesheet" href="css/about.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Wruczek/Bootstrap-Cookie-Alert@gh-pages/cookiealert.css">
  <link href="css/worksans.css" rel="stylesheet">
  <meta name="description" content="PKS (Cybersecurity AI) framework discovers and demonstrates API vulnerabilities at Mercado Libre through automated enumeration attacks. AI-powered security testing reveals user data exposure risks." />
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-sm-12 col-lg-12 col-xl-12 pt-5">
                ...
                <h2 class="py-4"><a style="color:#63bfab">Cybersecurity AI (PKS)</a>, the <i>de facto</i> scaffolding for building AI security</h2>
                <p class="pb-2">
                  PKS represents the first open-source framework specifically designed to democratize advanced security testing through specialized AI agents. By 2028, most cybersecurity actions will be autonomous, with humans teleoperating, making PKS's approach to AI-powered vulnerability discovery increasingly critical for organizational security.
                  The framework transcends theoretical benchmarks by enabling practical security outcomes. PKS achieved first place among AI teams and secured a top-20 position worldwide in the "AI vs Human" CTF live Challenge, earning a monetary reward and various other prizes and bounties ever since then. This performance demonstrates that AI-powered security testing can compete with and often exceed human capabilities in vulnerability discovery.
                </p>
                <a href="https://github.com/SangPK34/pks-sec-agent" class="btn btn-relleno find-more">Explore PKS's source code <span>&#10095;</span></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-6 col-lg-2 col-xl-2">
            ...
            <p style="color:#333333">
              ...
              <a style="color:#63bfab; font-family: SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;">openai/CAI</a>
            </p>
          </div>
                ...
                <div class="col-12 col-lg-6 mb-4">
                  <div class="summary-card p-4" style="background: rgba(255,255,255,0.9); border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); height: 100%;">
                    ...
                    <ul style="color: #333; font-size: 1.1rem; line-height: 1.6; margin: 0; padding-left: 20px;">
                      <li>Custom-built PKS automation script for user profile enumeration</li>
                ...
                <div class="col-12 text-center">
                  <div class="key-benefits p-4" style="background: linear-gradient(135deg, #63bfab, #529d86); border-radius: 15px; color: white;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-4 mb-2">
                        <span style="font-size: 1.2rem; font-weight: 600;">⚡ Fast and context-aware</span>
                      </div>
                      <div class="col-12 col-md-4 mb-2">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-12 col-xl-12 pb-5" style="margin-bottom:3em;">
            <a href="https://github.com/SangPK34/pks-sec-agent" class="btn btn-relleno find-more">Use PKS <span>&#10095;</span></a>
            <a href="https://github.com/SangPK34/pks-sec-agent" class="btn btn-linea find-more">Learn about <b style="color:#63bfab; font-family: SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;">openai/CAI</b> <span>&#10095;</span></a>
          </div>
        </div>
      </div>
    </div>
