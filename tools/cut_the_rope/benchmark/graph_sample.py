...
The script performs the following steps:
    ...
    2. Simulates log data with token statistics.
    3. Computes edge probabilities using simulated tokens and message count.
...
from pks.ctr.experiment import NodeInfo, EdgeInfo, GraphStructure
...
def main():
    ...
    # Compute edge probabilities with balanced weights.
